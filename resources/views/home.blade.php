...
<a class="breadcrumb-item" href="{{url('/profile/edit')}}">Profile</a>
<a class="breadcrumb-item" href="{{url('/contact')}}">Banner</a>
<a class="breadcrumb-item" href="{{url('/politely')}}">Politely</a>
<a class="breadcrumb-item" href="{{url('/contact')}}">Contact</a>
<a class="breadcrumb-item" href="{{url('/experience')}}">Experience</a>
<a class="breadcrumb-item" href="{{url('/front')}}">Front</a>
<a class="breadcrumb-item" href="{{url('/introduction')}}">Introduction</a>
<a class="breadcrumb-item" href="{{url('/logo')}}">Logo</a>
<a class="breadcrumb-item" href="{{url('/news')}}">News</a>
<a class="breadcrumb-item" href="{{url('/project')}}">Project</a>
<a class="breadcrumb-item" href="{{url('/skill')}}">Skill</a>
